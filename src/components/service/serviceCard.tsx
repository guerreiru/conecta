...
export function ServiceCard({
  ...
  return (
    ...
    >
      ...
      <footer className="flex flex-col md:flex-row md:items-center justify-between flex-wrap gap-3">
        <section className="grid gap-2" aria-label="Informações do serviço">
          ...
          {service.serviceType && (
            <span
              className="w-fit text-xs font-semibold px-2.5 py-1 rounded-lg bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300 flex items-center gap-1.5"
              role="status"
