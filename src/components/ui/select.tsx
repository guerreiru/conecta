    ...
    <div className="flex flex-col gap-1 w-full">
      ...
      <div className="relative w-full">
        <select
          ...
          ref={ref}
          {...rest}
          className="appearance-none min-h-12 bg-white dark:bg-black-200 rounded-lg px-3 pr-10 py-2 text-base leading-none
               disabled:bg-gray-200 disabled:text-gray-400 dark:disabled:bg-zinc-600 dark:disabled:text-zinc-400 w-full"
        >
